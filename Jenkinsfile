pipeline {	
    ...
    environment {
        ...
        DOCKERHUB_REPOSITORY = 'ziadhammaf/mlops-proj-01'
    }
    stages {
        ...
        stage('Trivy Docker Image Scan') {
            steps {
                ...
                script {
                    ...
                    sh "trivy image ${DOCKERHUB_REPOSITORY}:latest --format table -o trivy-fs-report.html"
            ...
            steps {
                ...
                script {
                    echo 'Deploying to production...'
                        sh "aws ecs update-service --cluster mlops-ecs --mlops-ecs-task-dev-service --force-new-deployment"
                    }
                }
            }
        }
